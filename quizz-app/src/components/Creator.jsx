...
export default function Creator() {
  return (
    <section className="creator">
      ...
      <p className="subtitle">connect and get to know me. feel free to quiz me in your intro!</p>
      ...
      <div className="img-container">
        ...
        <p className="description">Passionate about knowledge, fun, and minimal design.</p>
